...
export default function Footer() {
    return(
        <div>
            <footer id="footer" className="w-full px-8 py-10 bg-gray-900 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-3">
            <i className="text-xl text-primary" data-fa-i2svg="">
            ...
            <span className="font-bold text-white text-lg">FitPro Trainer</span>
        </div>
        <div className="text-gray-400 text-sm">© 2024 FitPro Trainer. All rights reserved.</div>
