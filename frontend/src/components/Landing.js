      ...
      >
        ...
        >
          ...
          <div className="flex gap-5 mt-2">
            <button
              id="book-session-btn"
              className="px-7 py-3 text-white rounded-lg font-bold text-lg shadow-lg bg-blue-600 hover:bg-green-600 duration-300 ease-in-out tracking-wide flex items-center gap-2"
            >
              <i data-fa-i2svg="">
                <svg
